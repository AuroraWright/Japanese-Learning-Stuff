...
function spdfHide() {
  ...
  document.getElementById("spdfSkip").style.display = "none";
}
function spdfShow() {
  document.getElementById("spdfControls").style.display = "";
  document.getElementById("spdfSkip").style.display = "";
}

const spdfButtonHTML = `
<td id="spdfSkip" width="50" align="center" valign="top" class="stat">
<span id="space" class="stattxt"></span><br>
<button title="Shortcut key: ${window.spdfHotkeySkipCard}"
    onclick="spdfSkip();">Skip card</button>
</td>
