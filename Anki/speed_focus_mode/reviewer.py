...
def on_skip_card():
    mw.reviewer.mw.col.reset()
    mw.reviewer.nextCard()
    mw.reviewer.mw.fade_in_webview()
    tooltip("Card skipped.")
...
<script>
    ...
    window.spdfHotkeySkipCard = "{local_conf['hotkeySkipCard']}";
</script>
...
def on_state_shortcuts_will_change(
    ...
    shortcuts.append((local_conf["hotkeySkipCard"], on_skip_card))
